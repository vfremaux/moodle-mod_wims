...
$string['wims:addinstance'] = 'Peut ajouter une instance au cours';
$string['wims:view'] = 'Peut voir le module';
...
$string['modulename_help']             = 'Intégrez un exercice, une feuille ou un examen Wims dans votre cours';
...
$string['adminnameserverpassword']     = 'Mot de passe de connexion du module Wims au serveur Wims';
$string['adminnameqcloffset']          = 'Point de départ de la numérotation des classes Wims créées par le module Wims';
$string['wimssettings']                = 'Réglages de l\'interface Moodle-Wims';
$string['adminnamelang']               = 'Langue';
...
$string['adminnamedebugviewpage']      = 'Activer l\'affichage d\'information de dbug: VIEW';
$string['adminnamedebugcron']          = 'Activer l\'affichage d\'information de dbug: CRON';
$string['adminnamedebugsettings']      = 'Activer l\'affichage d\'information de dbug: SETTINGS';
...
$string['username']                    = 'Nom complet de l\'enseignant';
...
$string['sheetgraded']                 = 'Notes Suivis';
